...
import { Scroll, Plus, Clock, CheckCircle2, AlertCircle } from "lucide-react";

const Quests = () => {
  const quests = [
    {
      title: "Тайна исчезнувших торговцев",
      status: "active",
      type: "Основной",
      progress: 60,
      description: "Расследуйте исчезновение караванов на Королевском тракте",
    },
    {
      title: "Реликвия Древних",
      status: "active",
      type: "Основной",
      progress: 30,
      description: "Найдите утерянный артефакт в руинах Элдарона",
    },
    {
      title: "Помощь кузнецу",
      status: "completed",
      type: "Побочный",
      progress: 100,
      description: "Доставьте редкую руду кузнецу Торгриму",
    },
    {
      ...
      type: "Побочный",
      progress: 0,
      description: "Очистите подвал таверны от гигантских крыс",
    },
    {
      title: "???",
      status: "hidden",
      type: "Скрытый",
      progress: 0,
      description: "Секретная сюжетная ветка",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 pt-24 pb-12">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground">
              Отслеживайте основные и побочные задания
            </p>
          </div>
        ...
        <div className="mt-12 p-8 bg-gradient-arcane rounded-lg">
          <h3 className="text-2xl font-serif font-bold mb-4 text-center">
            Древо сюжетных веток
          </h3>
          <p className="text-center text-muted-foreground mb-6">
            Визуализируйте разветвлённые сюжетные линии и последствия выборов
          </p>
